...
public class HLUtils {
	 ...
	 * @return
	 */
	public static <T> PageInfo<T> findByHighLight(ElasticsearchTemplate elasticsearchTemplate, Class<T> clazz, Integer pageNum,
			Integer pageSize, String fieldNames[], String value) {
		...
		//封装到对象中
		pageInfo = new PageInfo<T>(page_list);
